...
| --------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| Barbarian | Rage, Reckless (L1–2), Frenzy (L3), Danger Sense (L2), Extra Attack (L5), Fast Movement (L5), Feral Instinct (L7), Relentless Rage (L11), Persistent Rage (L15), Indomitable Might (L18), Primal Champion (L20) | Brutal Strike (exhaustion-on-rage-end is 2014-only, out of scope)                                                                       |

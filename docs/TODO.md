...
| Monk      | Martial Arts, Flurry/Patient/Step (L2), Uncanny Metabolism (L2), Stunning Strike (L5), Extra Attack (L5), Evasion (L7)                                                                                                              | Deflect Attacks, Slow Fall, Self-Restoration, Disciplined Survivor, Empty Body, Body & Mind, higher Open Hand grades     |

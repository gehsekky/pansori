...
| Monk      | Martial Arts, Flurry/Patient/Step (L2), Uncanny Metabolism (L2), Deflect Attacks (L3), Stunning Strike (L5), Extra Attack (L5), Evasion (L7), Self-Restoration (L10), Body and Mind (L20)                                           | Slow Fall, Disciplined Survivor, Empty Body, higher Open Hand grades                                                     |

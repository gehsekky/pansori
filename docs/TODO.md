...
| Monk      | Martial Arts, Flurry/Patient/Step (L2), Uncanny Metabolism (L2), Deflect Attacks (L3), Stunning Strike (L5), Extra Attack (L5), Evasion (L7), Self-Restoration (L10), Disciplined Survivor (L14), Body and Mind (L20)               | Slow Fall (narrative — no falling-damage model), Empty Body (L18), higher Open Hand grades                               |

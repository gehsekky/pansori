...
export const ACTION_COSTS: Record<StructuredAction['type'], ActionCost> = {
  ...
  choose_blessed_strikes: 'managed',
  choose_divine_order: 'managed',
  choose_spell_mastery: 'managed',
  choose_signature_spell: 'managed',
  choose_evocation_savant: 'managed',
  choose_fiendish_resilience: 'managed',
  choose_mystic_arcanum: 'managed',
  memorize_spell: 'managed',
  ...
  sell: 'managed', // vendor pane — out-of-combat trade, no action economy

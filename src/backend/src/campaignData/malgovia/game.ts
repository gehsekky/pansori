...
export const narratives: Context['narratives'] = {
  ...
  combatHit: {
    healthy: [
      'With fluid confidence, {The_enemy} reels from the blow.',
      'Your attack connects cleanly — {the_enemy} staggers.',
      'A solid strike lands on {the_enemy}.',
    ],
    hurt: [
      'Despite your wounds, you land a telling blow on {the_enemy}.',
      'Gritting through the pain, your attack finds {the_enemy}.',
      'Desperate and determined, your strike connects with {the_enemy}.',
    ],
    critical: [
      'Barely standing, you somehow find the strength to strike {the_enemy}.',
      'On sheer will alone, your blow hammers {the_enemy}.',
    ],
  },
  combatMiss: {
    healthy: [
      "Your strike glances off {the_enemy}'s guard.",
      '{The_enemy} sidesteps neatly.',
      'Your blow goes wide.',
    ],
    hurt: [
      'Pain throws off your aim — {the_enemy} avoids it.',
      'Your wounded arm betrays you; {the_enemy} steps aside.',
    ],
    critical: [
      'You can barely lift your weapon — the attack fails entirely.',
      '{The_enemy} brushes aside your feeble attempt.',
    ],
  },
  enemyAttacks: [
    '{The_enemy} attacks!',
    '{The_enemy} strikes at you!',
    '{The_enemy} presses the assault!',
  ],
  killShot: [
    '{The_enemy} collapses, broken and still.',
    '{The_enemy} falls — the threat is ended.',
    'With a final blow, {the_enemy} is destroyed.',
  ],
  lootPickedUp: [
    'You pocket the {item}.',
  ...
  enemyDeflected: [
    "{The_enemy}'s blow glances off your armor.",
    '{The_enemy} attacks but finds no opening.',
    "You turn aside {the_enemy}'s strike.",
  ],
  levelUp: [
  ...
  combatStart: [
    '{The_enemy} bars your path — initiative is drawn!',
    'Combat begins! {The_enemy} readies for battle.',
  ],

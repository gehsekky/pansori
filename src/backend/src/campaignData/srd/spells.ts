...
export const SRD_SPELLS: Record<string, Spell> = {
  ...
  animal_shapes: {
    ...
    rangeKind: 'ranged',
    rangeFt: 30,
    desc: 'Transform willing creatures into Large-or-smaller beasts (your choice of one form) for the duration. Concentration, up to 1 day.',
  ...
  shapechange: {
    ...
    concentration: true,
    rangeKind: 'self',
    desc: 'Assume the form of any creature you’ve seen (CR ≤ your level), gaining its statistics while keeping your mind, for the duration. Concentration, up to 1 hour.',

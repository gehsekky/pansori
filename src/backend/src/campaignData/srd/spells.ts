...
export const SRD_SPELLS: Record<string, Spell> = {
  ...
  time_stop: {
    ...
    castTime: 'action',
    rangeKind: 'self',
    desc: 'Stop time for everyone but you, taking 1d4 + 1 turns in a row — the effect ends early if you affect another creature or move far from where you cast it.',

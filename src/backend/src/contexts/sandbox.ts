...
export const context: Context = {
  ...
  spellTable: {
    ...
    fireball: {
      ...
      upcastBonus: '1d6', blastRadius: 20,
    },
    guiding_bolt: {
      ...
      attackRoll: true, upcastBonus: '1d6',
    },
    hold_person: {
    ...
    eldritch_blast: {
      id: 'eldritch_blast', name: 'Eldritch Blast', desc: 'A beam of crackling energy streaks toward a creature.',
      level: 0, castTime: 'action', damage: '1d10', damageType: 'force',
      attackRoll: true, upcastBonus: '1d10',
    },
    healing_word: {
      id: 'healing_word', name: 'Healing Word', desc: 'A creature of your choice regains HP.',
      level: 1, castTime: 'bonus_action', heal: '1d4',
      upcastBonus: '1d4',
    },
    shillelagh: {
      id: 'shillelagh', name: 'Shillelagh', desc: 'Your staff deals 1d8 magical bludgeoning damage using WIS for attack/damage.',
      level: 0, castTime: 'bonus_action', narrative: 'Your staff glows with natural energy.',
    },
    entangle: {
      id: 'entangle', name: 'Entangle', desc: 'Grasping weeds restrain creatures in a 20-ft square.',
      level: 1, castTime: 'action', damage: '0', damageType: 'none',
      savingThrow: 'str', saveEffect: 'negates',
      condition: 'restrained', conditionDuration: 3,
      concentration: true, blastRadius: 20,
    },
    charm_person: {
      id: 'charm_person', name: 'Charm Person', desc: 'A humanoid is charmed for 1 hour.',
      level: 1, castTime: 'action',
      savingThrow: 'wis', saveEffect: 'negates',
      condition: 'charmed', conditionDuration: 6,
    },
    sleep: {
      id: 'sleep', name: 'Sleep', desc: 'Sends creatures into a magical slumber (5d8 HP pool).',
      level: 1, castTime: 'action', damage: '5d8', damageType: 'none',
      savingThrow: 'con', saveEffect: 'negates',
      condition: 'unconscious', conditionDuration: 3,
      upcastBonus: '2d8',
    },
    burning_hands: {
      id: 'burning_hands', name: 'Burning Hands', desc: 'A thin sheet of flame shoots from your hands.',
      level: 1, castTime: 'action', damage: '3d6', damageType: 'fire',
      savingThrow: 'dex', saveEffect: 'half',
      upcastBonus: '1d6', blastRadius: 15,
    },
    bless: {
      id: 'bless', name: 'Bless', desc: 'Up to 3 creatures add 1d4 to attack rolls and saving throws.',
      level: 1, castTime: 'action', narrative: 'Divine blessing radiates over your allies.',
      concentration: true,
    },
    spiritual_weapon: {
      id: 'spiritual_weapon', name: 'Spiritual Weapon', desc: 'A floating spectral weapon makes melee attacks.',
      level: 2, castTime: 'bonus_action', damage: '1d8', damageType: 'force',
      upcastBonus: '1d8',
    },
    hex: {
      id: 'hex', name: 'Hex', desc: 'Curse a creature — bonus 1d6 necrotic on every hit.',
      level: 1, castTime: 'bonus_action', narrative: 'A dark curse settles on your target.',
      concentration: true,
    },
    hunger_of_hadar: {
      id: 'hunger_of_hadar', name: 'Hunger of Hadar', desc: 'Open a gate to the void — creatures inside take 2d6 cold and DEX save or 2d6 acid.',
      level: 3, castTime: 'action', damage: '2d6', damageType: 'cold',
      savingThrow: 'dex', saveEffect: 'half',
      concentration: true, blastRadius: 20,
    },
  },
  ...
  classSpells: {
    ...
    Cleric:   ['sacred_flame', 'cure_wounds', 'guiding_bolt', 'hold_person', 'bless', 'spiritual_weapon'],

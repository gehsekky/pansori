...
export const context: Context = {
  ...
  campaign: {
    ...
    rooms: [
      ...
      },
      {
        ...
        desc: "Marta's lodge — pelts hanging in racks, snowshoes and warhammers along the wall.",
      },
      {
        id: 'pines_warden',
        name: 'Warden Post',
      ...
      },
      {
        ...
        name: 'Frozen Hall',
        desc: 'A long pillared hall sheathed in ice. Frost mephits glitter in the air like motes of dust.',
        lighting: 'dark',
      },
      {
  ...
  classSpells: {
    Cleric: ['sacred_flame', 'cure_wounds', 'guiding_bolt', 'bless'],
    Wizard: ['fire_bolt', 'magic_missile', 'burning_hands', 'thunderwave'],

...
import { context as sandbox } from '../../src/campaignData/sandbox.js';
import { context as vale } from '../../src/campaignData/malgovia/index.js';

const __filename = fileURLToPath(import.meta.url);
// This spec lints the ENGINE SOURCE on disk — it lives in tests/ but
// reads from the mirrored src/services directory.
const __dirname = join(dirname(__filename), '../../src/services');

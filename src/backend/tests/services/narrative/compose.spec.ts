import type { Character, Context, GameState, LootItem } from '../../../src/types.js';
...
import {
  ...
  renderSpellUtility,
} from '../../../src/services/narrative/compose.js';
import { makeChar, makeEnemy, makeMinimalContext } from '../../../src/test-fixtures.js';
import type { ActionContext } from '../../../src/services/actions/types.js';
import { buildCombatHitNarrative } from '../../../src/services/gameEngine.js';

...
export const context: FrontendContext = {
  ...
  backgrounds: [
    { id: 'soldier',  name: 'Soldier',  desc: 'You have served in an organized military force.',    skillProficiencies: ['athletics', 'intimidation'], toolProficiency: null,             feature: 'Military Rank',          featureDesc: 'Soldiers and veterans recognize your authority.' },
    { id: 'criminal', name: 'Criminal', desc: 'You have a history of breaking the law.',            skillProficiencies: ['stealth', 'deception'],      toolProficiency: "Thieves' Tools", feature: 'Criminal Contact',       featureDesc: 'You have a contact for information and fencing goods.' },
    { id: 'sage',     name: 'Sage',     desc: 'You spent years learning the lore of the multiverse.', skillProficiencies: ['arcana', 'history'],        toolProficiency: null,             feature: 'Researcher',             featureDesc: 'If you do not know information, you know where to find it.' },
    { id: 'acolyte',  name: 'Acolyte',  desc: 'You have spent your life in service to a temple.',   skillProficiencies: ['religion', 'insight'],       toolProficiency: null,             feature: 'Shelter of the Faithful', featureDesc: 'Temples provide healing and care to you and your companions.' },
  ],

import {
  ShieldChevron, Sword, Crosshair, Drop, Scroll,
...
export const context: FrontendContext = {
  ...
  * it knows you're here`,
  ...
  classes: [
    { id: 'Biologist', desc: 'High WIS. Medicine + Perception. Understands what it is. Still has to fight it.' },
    { id: 'Diver',     desc: 'High CON. Athletics + Survival. Six hundred dives. This one is different.' },
    ...
    { id: 'Medic',     desc: 'High WIS. Medicine + Survival. Triage decision: neutralize threat first.' },
  ],

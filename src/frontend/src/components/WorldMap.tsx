    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
          <p style={{ fontSize: '0.7rem', letterSpacing: '0.18em', color: 'var(--t-dim)', margin: 0 }}>
          ...
          <button
            ...
            style={{
              ...
              fontSize: '1rem', fontFamily: 'inherit', lineHeight: 1,
            }}
          >✕</button>
        </div>
          ...
          {rooms.map((room, i) => {
            ...
            return (
              <g key={room.id}>
                ...
                {isCur && (
                  <circle cx={x} cy={nodeY} r={R + 6}
                    fill="none" stroke="var(--t-primary)"
        ...
        <div style={{
          ...
          fontSize: '0.62rem', color: 'var(--t-dim)', letterSpacing: '0.08em',
        }}>

...
// Campaign content editor (pilot surface): one editable Context section at
// a time as raw JSON. Sections resolve DB-first with code supplement — the
// source badge says which version the engine is serving; SAVE writes the
// DB version (live immediately, no restart); REVERT TO CODE deletes the DB
// version so the campaignData files take over again. Structured per-section
// editors can replace the JSON textarea later without touching the API.
